...
const BusinessSummery = () => {
  return (
    <>
      <h1 className="text-center text-xl font-semibold md:text-5xl text-primary my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-10">
        <div className="stat shadow-lg">
          ...
          <div className="stat-title text-xl font-bold">Revinue</div>
          <div className="stat-value">31K</div>
          <div className="stat-desc font-bold">
            Jan 1<sup>st</sup> - May 31<sup>st</sup>
          </div>
        </div>
        ...
        <div className="stat shadow-lg">
          ...
          <div className="stat-title text-xl font-bold">Review</div>
