...
const Blog = () => {
  return (
    <div className="bg-zinc-100">
      <div className="md:mx-48 py-20 px-5">
        ...
        <p className="md:text-lg md:font-medium">
          ...
          It is done during the coding phase by the developers. A developer
          writes a piece of code (unit tests) to ensure that a section of an
          application (known as the "unit") meets its design and behaves as
          intended.
        </p>
        <h4 className="text-xl font-bold mb-5 text-red-500 mt-5">
        ...
        <p className="md:text-lg md:font-medium">
          ...
          the code need to be checked. Unit testing can be easily integrated
          into the software build process, making it easy to report errors
          quickly. Since unit testing can be automated, it can decrease the
          total testing cost.
        </p>
        <h4 className="text-xl font-bold mb-5 text-red-500 mt-5">
        ...
        <p className="md:text-lg md:font-medium">
          To change a value in the state object, use the setState() method. When
          a value in the state object changes, the component will re-render,
          ...
          virtual DOM as well as the new virtual DOM. The process to update
          React state is asynchronous for performance reasons.
        </p>
        <h4 className="text-xl font-bold mb-5 text-red-500 mt-5">
        ...
        <p className="md:text-lg md:font-medium">
          ...
          include helpful warnings. This can be very useful while developing,
          but it can make the app size large and responses slower than usual. To
          solve this we should use production build before deploying.
        </p>
        <p className="md:text-lg md:font-medium">
          React comes bundled with the React.lazy() API so that you can render a
          dynamic import as a regular component. Lazy loading is a great
          technique for optimizing and speeding up the render time of your app.
        </p>

        <p className="md:text-lg md:font-medium">
          React.memo() is a great way of optimizing performance as it helps
          cache functional components.
        </p>
        <p className="md:text-lg md:font-medium">
        ...
        <div className="md:text-lg md:font-medium">
          <p>
            There are four main types of states we need to properly manage in
            our React apps:
          </p>
          <p>
          ...
          <p>
            Global (UI) state – Global state is necessary when we want to get
            and update data anywhere in our app, or in multiple components at
            least.
          </p>
          <p>
            Server state – there are several pieces of state that must be
            managed every time you fetch or update data from an external server,
            including loading and error states. Data that comes from an external
            server must be integrated with our UI state. SWR and React Query
